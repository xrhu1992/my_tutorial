...
## 5. 光学元器件(Optical Components)
### 5.1 四分之一波片(Quarter-wave Plate)
...
- 有一类材料，对于不同偏振方向的入射光，会有不同的折射率（也就是有不同的传播速度）。而1/4波片就是控制材料和厚度使光经过波片后，两个不同偏振方向的光产生1/4波长的相位差，在此相位差下合成的光为圆偏振光，如下示意图：
  <p align="center">
